  ...
  if (Astro2.request.method === "POST") {
    ...
    await db.execute({
      ...
      args: [
        finalPatientId,
        nutritionistId,
        data.get("caloricRequirement"),
        macrosDistribution,
        data.get("weeklyMenu"),
        "",
        data.get("generalRecommendations")
      ]
    });
