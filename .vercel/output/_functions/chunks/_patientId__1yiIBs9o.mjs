...
import 'piccolore';
import { B as maybeRenderHead, a3 as addAttribute, Q as renderTemplate, b7 as unescapeHTML } from './sequence_D80S23pC.mjs';
...
const $$patientId = createComponent(($$result, $$props, $$slots) => {
  ...
  const mockItems = {
    citas: [
      ...
      { id: 2, date: "22/04/2026", time: "11:30 AM", doctor: "Dr. Gómez", status: "Pendiente" }
    ],
    lesiones: [
