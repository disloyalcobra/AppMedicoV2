  ...
  if (Astro2.request.method === "POST") {
    ...
    await db.execute({
      sql: `INSERT INTO NutritionalFollowUps (
            planId, followUpDate, currentWeight, currentBmi, adherencePercent, notes
          ) VALUES (?, ?, ?, ?, ?, ?)`,
      args: [
        finalPlanId,
        date,
